        ...
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 16}}>
              (입맛춤 어플리케이션'이하 '입맛춤')은(는) 「개인정보 보호법」
            ...
            <View style={{height: '62%', marginTop: 15}}>
              <ScrollView
                ...
                <Text style={{fontSize: 17}}>제1조(개인정보의 처리 목적)</Text>
                <Text style={{fontSize: 15, marginTop: 20}}>
                  '입맛춤'은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
                ...
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ...
                  제공에 따른 본인 식별·인증 목적으로 개인정보를 처리합니다.
                </Text>
                <Text style={{fontSize: 17, marginTop: 15}}>
                  제2조(개인정보의 처리 및 보유 기간)
                </Text>
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ① '입맛춤'은(는) 법령에 따른 개인정보 보유·이용기간 또는
                ...
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ① '입맛춤'은(는) 다음의 개인정보 항목을 처리하고 있습니다. 1.
                  ( 홈페이지 회원가입 및 관리 ) 필수항목 : 비밀번호, 로그인ID,
                  성별, 서비스 이용 기록 선택항목 :
                </Text>
                ...
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ① '입맛춤'은(는) 개인정보를 제1조(개인정보의 처리 목적)에서
                  명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한
                  규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는
                  경우에만 개인정보를 제3자에게 제공합니다.
                </Text>
                <Text style={{fontSize: 15, marginTop: 15}}>
                  ② '입맛춤'은(는) 다음과 같이 개인정보를 제3자에게 제공하고
                  있습니다. 1. ( 없음 ) 개인정보를 제공받는 자 : 없음 제공받는
                  자의 개인정보 이용목적 : 제공받는 자의 보유.이용기간:
                </Text>
                ...
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ① '입맛춤'은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
                ...
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ...
                  '입맛춤' 은(는) 파기 사유가 발생한 개인정보를 선정하고,
                  '입맛춤' 의 개인정보 보호책임자의 승인을 받아 개인정보를
                  파기합니다. 2. 파기방법 전자적 파일 형태의 정보는 기록을
                ...
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ① 정보주체는 '입맛춤'에 대해 언제든지 개인정보
                  열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
                </Text>
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ② 제1항에 따른 권리 행사는('입맛춤 어플리케이션'이하
                  '입맛춤')에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라
                  서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며
                  '입맛춤'은(는) 이에 대해 지체 없이 조치하겠습니다.
                </Text>
                <Text style={{fontSize: 15, marginTop: 20}}>
                ...
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ⑥ '입맛춤'은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
                ...
                <Text style={{fontSize: 17, marginTop: 15}}>
                  '입맛춤'은(는) 개인정보의 안전성 확보를 위해 다음과 같은
                  조치를 취하고 있습니다.
                </Text>

                <Text style={{fontSize: 15, marginTop: 20}}>
                  1. 정기적인 자체 감사 실시. 개인정보 취급 관련 안정성 확보를
                  위해 정기적(분기 1회)으로 자체 감사를 실시하고 있습니다.
                </Text>
                <Text style={{fontSize: 15, marginTop: 20}}>
                  2. 개인정보의 암호화. 이용자의 개인정보는 비밀번호는 암호화
                  되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한
                  데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을
                  사용하는 등의 별도 보안기능을 사용하고 있습니다.
                </Text>
                <Text style={{fontSize: 15, marginTop: 20}}>
                  3. 문서보안을 위한 잠금장치 사용. 개인정보가 포함된 서류,
                  보조저장매체 등을 잠금장치가 있는 안전한 장소에 보관하고
                  있습니다.
                </Text>

                <Text style={{fontSize: 17, marginTop: 15}}>
                  제8조(개인정보를 자동으로 수집하는 장치의 설치·운영 및 그
                  거부에 관한 사항)
                </Text>

                <Text style={{fontSize: 15, marginTop: 20}}>
                  ① '입맛춤'은(는) 이용자에게 개별적인 맞춤서비스를 제공하기
                ...
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ① Let Eat Go 은(는) 개인정보 처리에 관한 업무를 총괄해서
                  책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및
                  피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를
                  지정하고 있습니다.
                </Text>
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ▶ 개인정보 보호책임자 -성명 : 김성은 -직책 : 서버관리 -직급
                  :관리자 - 연락처 :01040047248, sekim520@gmail.com,
                </Text>

                <Text style={{fontSize: 15, marginTop: 20}}>
                  ② 정보주체께서는 '입맛춤'의 서비스(또는 사업)을 이용하시면서
                  발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에
                  관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
                  있습니다. Let Eat Go 은(는) 정보주체의 문의에 대해 지체 없이
                  답변 및 처리해드릴 것입니다.
                </Text>

                <Text style={{fontSize: 17, marginTop: 15}}>
                  제10조(개인정보의 열람청구를 접수·처리하는 부서) 정보주체는
                  ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의
                  부서에 할 수 있습니다. "입맛춤"은(는) 정보주체의 개인정보
                  열람청구가 신속하게 처리되도록 노력하겠습니다.
                </Text>
                <Text style={{fontSize: 15, marginTop: 20}}>
                  ▶ 개인정보 열람청구 접수·처리 부서 부서명 :렛잇고 담당자
                  :정윤미 연락처 : 010-5135-8136
                </Text>
